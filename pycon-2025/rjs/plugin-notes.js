(function(t) {
    if (typeof t.exports === "object" && typeof t.module !== "undefined") {
        t.module.exports = Plugin();
    } else if (typeof t.define === "function" && t.define.amd) {
        t.define(Plugin);
    } else {
        t.RevealNotes = Plugin();
    }
    ...
    function Plugin() {
        ...
        function openSpeakerWindow() {
            ...
            if(speakerWindow && !speakerWindow.closed) {
                ...
                speakerWindow = window.open('rjs/speaker-view.html', 'reveal.js - Notes', 'width=1100,height=700');
                if(!speakerWindow) {
        ...
        function onPostMessage(event) {
            ...
            try {
                if (isSameOriginEvent(event) && typeof(event.data) === "string") {
